...
public class Book implements Serializable {
    ...
    public String toString() {
        return "Book{" + "id=" + id + ", título=" + titulo + ", año de publicación=" + anio + ", ejemplares totales=" + ejemplares + ", ejemplare prestados=" + ejemplarePrestados + ", ejemplares disponibles en stock" + ejemplaresRestantes + ", alta=" + disponible() + ", Autor=" + autor + ", Editorial=" + editorial + '}';
    }
